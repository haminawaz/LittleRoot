      ...
      <section className="container mx-auto px-4 py-8 md:py-12 lg:py-16">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div data-aos="fade-right">
            ...
            <h1 className="text-5xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-[5rem] font-bold text-gray-900 mb-4 md:mb-6 leading-tight">
              Turn Stories into{" "}
            ...
            <p className="text-base md:text-md lg:text-xl xl:text-2xl text-gray-600 mb-6 md:mb-8 leading-relaxed">
          ...
          <div
            className="relative w-full flex items-center justify-center order-1 md:order-2 mb-8 md:mb-0 px-8 md:px-12 lg:px-0"
            data-aos="fade-left"
            data-aos-delay="200"
          >
